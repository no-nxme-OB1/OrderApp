...
class MenuTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Task.init{
            do {
                let menuItems = try await MenuController.shared.fetchMenuItem(forCategory: category)
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, didEndDisplaying cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        //cancels the image fetching tasks if its no longer needed.
   ...
   /* func configure(_ cell: UITableViewCell, forItemAt indexPath: IndexPath) {
        ...
        //content.secondaryText = "R\(menuItem.price)"
        content.secondaryText = menuItem.price.formatted(.currency(code: "zar"))
